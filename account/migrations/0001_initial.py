    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_type', models.PositiveIntegerField(choices=[(1, 'Seeker'), (2, 'Owner'), (3, 'Maintainer')], default=1)),
                ('citizenship_number', models.CharField(editable=False, max_length=255, null=True, unique=True, validators=[account.validators.validate_citizenship_number])),
                ('citizenship_back', models.ImageField(null=True, upload_to=account.models.upload_citizenship_back_to)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='reset_password_codes', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ('-created_at',),
            },
